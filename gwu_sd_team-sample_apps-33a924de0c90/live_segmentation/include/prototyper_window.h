#ifndef PROTOTYPER_WINDOW_H
#define PROTOTYPER_WINDOW_H


#include "prototyper_window_qt.h"
...
namespace Ui {
  class Prototyper_Window;
}

class Prototyper_Window : public QMainWindow
{
    Q_OBJECT
  ...
  public:
    ...
    Prototyper_Window(pcl::Grabber& grabber);
