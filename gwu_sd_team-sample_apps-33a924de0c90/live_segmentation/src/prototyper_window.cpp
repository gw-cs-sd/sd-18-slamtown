...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Prototyper_Window::Prototyper_Window (pcl::Grabber& grabber) : grabber_ (grabber)
{
  //Create a timer
  ...
  boost::function<void (const CloudConstPtr&)> f = boost::bind (&Prototyper_Window::cloud_cb, this, _1);
...
void
Prototyper_Window::cloud_cb (const CloudConstPtr& cloud)
{
  if (!capture_)
    return;
...
void
Prototyper_Window::useEuclideanComparatorPressed ()
{
  QMutexLocker locker (&mtx_);
...
void
Prototyper_Window::useRGBComparatorPressed ()
{
  QMutexLocker locker (&mtx_);
...
void
Prototyper_Window::usePlaneComparatorPressed ()
{
  QMutexLocker locker (&mtx_);
...
void
Prototyper_Window::useEdgeAwareComparatorPressed ()
{
  QMutexLocker locker (&mtx_);
...
void
Prototyper_Window::displayCurvaturePressed ()
{
  display_curvature_ = !display_curvature_;
}

void
Prototyper_Window::displayDistanceMapPressed ()
{
  display_distance_map_ = !display_distance_map_;
}

void
Prototyper_Window::displayNormalsPressed ()
{
