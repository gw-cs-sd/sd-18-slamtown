...
macro(find_boost)
  if(PCL_ALL_IN_ONE_INSTALLER)
    message(" BOOST from ${PCL_ROOT}/3rdParty/Boost")
    set(BOOST_ROOT "${PCL_ROOT}/3rdParty/Boost")
  elseif(NOT BOOST_INCLUDEDIR)
    message(" BOOST from /home/pablo/workplace/source/boost_1_52_0")
    set(BOOST_INCLUDEDIR "/home/pablo/workplace/source/boost_1_52_0")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/pablo/workplace/source/pcl-trunk")
...
set(pcl_all_components  common geometry octree io stereo kdtree search sample_consensus filters 2d features registration cuda_common cuda_sample_consensus cuda_features cuda_segmentation tracking ml segmentation surface recognition keypoints visualization simulation outofcore people apps modeler cloud_composer point_cloud_editor 3d_rec_framework in_hand_scanner gpu_containers gpu_utils gpu_octree gpu_kinfu_large_scale gpu_segmentation gpu_features gpu_kinfu )
