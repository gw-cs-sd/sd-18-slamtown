...
// Open Lepton I2C
int leptonI2C_connect() {
	LEP_RESULT result = LEP_OpenPort(1, LEP_CCI_TWI, 400, &_port);
	printf("Open port: %d, with address %d \n", result, _port.deviceAddress);
...
void leptonI2C_ShutterOpen() {
	LEP_SYS_SHUTTER_POSITION_E position = LEP_SYS_SHUTTER_POSITION_OPEN;
	LEP_SetSysShutterPosition(&_port, position);
} 
void leptonI2C_ShutterClose() {
...
int leptonI2C_InternalTemp()
{
	LEP_SYS_FPA_TEMPERATURE_KELVIN_T sensor_temp_kelvin;
	//LEP_SYS_FPA_TEMPERATURE_CELCIUS_T sensor_temp_celsius;
	//if(!_connected) {
	//	leptonI2C_connect();
	//}
	LEP_GetSysFpaTemperatureKelvin(&_port, &sensor_temp_kelvin);
        //LEP_GetSysFpaTemperatureCelcius(&_port, &sensor_temp_celsius);

	//printf(" Kelvin: %d \n", sensor_temp_kelvin);
	//printf(" Celsius: %f \n", sensor_temp_celsius);

	return sensor_temp_kelvin;
}
...
unsigned int spi_speed = SPI_SPEED; //16MHz
...
//============================================================================
// Lepton IR frame coloring scheme
//============================================================================
